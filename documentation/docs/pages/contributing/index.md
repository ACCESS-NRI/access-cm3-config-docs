...
There's agenda (before the meeting) and minutes (after) the meetings [here](https://forum.access-hive.org.au/t/cm3-dev-eval-working-group-meeting-minutes-2025/5393), anyone can share a figure or contribute to the agenda. The draft agenda is a "wiki" post, so anyone is able to paste a figure for an upcoming evaluation meeting.

Ideally (not required), figure contributions are also made with corresponding analysis code, these contributions are coordinated on the [CM3 evaluation ACCESS-Community-Hub repository](https://github.com/ACCESS-Community-Hub/access-cm3-paper-1/). All community members (and ACCESS-NRI staff) can get write access to the CM3 evaluation repository. To get write access, you need to create an issue and request access [using this issue template](https://github.com/ACCESS-Community-Hub/access-cm3-paper-1/issues/new?template=add-user-request-to--access-cm3-1-repository-.md). Evaluation figures are being coordinated [here](https://github.com/ACCESS-Community-Hub/access-cm3-paper-1/issues/1). If you want to contribute analysis code and figures, and would like information on the practical steps, see the [README](https://github.com/ACCESS-Community-Hub/access-cm3-paper-1/blob/main/README.md).
